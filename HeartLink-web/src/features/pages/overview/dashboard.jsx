    ...
    return (
      <AdminLayout>
        <div className={UI.page.container} style={{ fontFamily: FONTS.sans }}>
          ...
          <Skeleton className="w-full h-[120px] rounded-[10px] mb-5 bg-[#E2E8F0]/60" />

          {/* KPI Grid Skeleton */}
          <div className={UI.kpi.grid}>
            <Skeleton className="w-full h-[100px] rounded-[10px] bg-[#E2E8F0]/60" />
            <Skeleton className="w-full h-[100px] rounded-[10px] bg-[#E2E8F0]/60" />
            <Skeleton className="w-full h-[100px] rounded-[10px] bg-[#E2E8F0]/60" />
            <Skeleton className="w-full h-[100px] rounded-[10px] bg-[#E2E8F0]/60" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 mb-5">
            <Skeleton className="w-full h-[240px] rounded-[10px] bg-[#E2E8F0]/60" />
            <Skeleton className="w-full h-[240px] rounded-[10px] bg-[#E2E8F0]/60" />
          </div>

          {/* Activity Skeleton */}
          <Skeleton className="w-full h-[140px] rounded-[10px] mb-5 bg-[#E2E8F0]/60" />

          {/* Bottom Grid Skeleton */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
            <Skeleton className="w-full h-[220px] rounded-[10px] bg-[#E2E8F0]/60" />
            <Skeleton className="w-full h-[220px] rounded-[10px] bg-[#E2E8F0]/60" />
          </div>
        </div>
      </AdminLayout>
  ...
  return (
    <AdminLayout>
      ...
      <div className="w-full max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-8 py-4" style={{ fontFamily: FONTS.sans }}>
        ...
        {/* ── QUICK ACTIONS ── */}
        <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-[10px] p-5 mb-5 shadow-2xs">
          <div className="text-[13px] font-semibold text-[#0F172A] mb-0.5">Quick actions</div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 mt-3.5">
            <button
              onClick={() => navigate("/foods")}
              className="flex items-center gap-3 p-3 rounded-[8px] border border-[#E2E8F0] bg-[#F8FAFC] hover:border-[#2E9AE8] hover:bg-[#EAF5FC] transition-all cursor-pointer text-left group"
            >
              <div className="w-8 h-8 rounded-[7px] shrink-0 flex items-center justify-center bg-[#EAF5FC] text-[#2E9AE8] group-hover:bg-[#2E9AE8] group-hover:text-white transition-colors">
                <Utensils size={15} strokeWidth={2} />
              </div>
              <div>
                <p className="m-0 text-[12.5px] font-semibold text-[#0F172A]">Add recipe</p>
                <span className="text-[11px] text-[#64748B] font-medium">Nutritional library</span>
              </div>
            </button>
            ...
            >
              ...
              <div>
                <p className="m-0 text-[12.5px] font-semibold text-[#0F172A]">Add exercise</p>
                <span className="text-[11px] text-[#64748B] font-medium">Workout regimens</span>
              </div>
            </button>
            ...
            >
              ...
              <div>
                <p className="m-0 text-[12.5px] font-semibold text-[#0F172A]">View users</p>
                <span className="text-[11px] text-[#64748B] font-medium">Patient database</span>
              </div>
            </button>
            ...
            >
              ...
              <div>
                <p className="m-0 text-[12.5px] font-semibold text-[#0F172A]">Review cases</p>
                <span className="text-[11px] text-[#64748B] font-medium">Clinical evaluations</span>
              </div>
            </button>
          </div>
        </div>
        ...
        <div className={UI.kpi.grid}>
          ...
          <KpiCard
            ...
            icon={AlertTriangle}
            iconBg={Number(kpi?.open_alerts) > 0 ? "bg-[#F7E4E1]" : "bg-[#F8FAFC]"}
            iconColor={Number(kpi?.open_alerts) > 0 ? "text-[#A93226]" : "text-[#64748B]"}
            valueColor={Number(kpi?.open_alerts) > 0 ? "text-[#A93226]" : "text-[#0F172A]"}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3.5 mb-5">
          ...
          <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-[10px] p-5 shadow-2xs flex flex-col justify-between">
            <div>
              <div className="text-[13px] font-semibold text-[#0F172A] mb-0.5">Users needing review</div>
              <div className="text-[12px] text-[#64748B] mb-4">Clinical items flagged for verification and analysis</div>

              <div className="space-y-2">
                <div 
                  onClick={() => navigate("/users")}
                  className="flex items-center justify-between p-2.5 px-3 rounded-[8px] border border-[#E2E8F0] hover:border-[#94A3B8] hover:bg-[#F8FAFC] transition-all cursor-pointer"
                >
                  <div className="flex items-center gap-2.5 text-[12.5px] font-medium text-[#0F172A]">
                    <span className="w-2 h-2 rounded-full bg-[#A93226]" />
                    Critical HSS users
                  </div>
                  <span className="text-[12px] font-bold text-[#0F172A] bg-[#F8FAFC] border border-[#E2E8F0] px-2.5 py-0.5 rounded-[6px]">
          ...
          <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-[10px] p-5 shadow-2xs">
            <div className="text-[13px] font-semibold text-[#0F172A] mb-0.5">HSS distribution</div>
            <div className="text-[12px] text-[#64748B] mb-4">Health Stability Score cohorts across registered population</div>
            ...
            <div className="space-y-3.5">
              ...
              <div>
                ...
                <div className="w-full h-1.5 rounded-full bg-[#F8FAFC] overflow-hidden">
                  <div 
              ...
              <div>
                ...
                <div className="w-full h-1.5 rounded-full bg-[#F8FAFC] overflow-hidden">
                  <div 
                    className="h-full rounded-full bg-[#2E9AE8] transition-all duration-500"
        ...
        {/* ── USER ACTIVITY ── */}
        <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-[10px] p-5 mb-5 shadow-2xs">
          <div className="text-[13px] font-semibold text-[#0F172A] mb-0.5">User activity (last 7 days)</div>
          <div className="text-[12px] text-[#64748B] mb-3.5">Clinical telemetry events recorded in the rolling week</div>

          <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5 mt-3.5">
            <div className="text-center p-3.5 px-2 border border-[#E2E8F0] rounded-[8px] bg-[#F8FAFC]">
              <span className="text-[10.5px] uppercase tracking-[0.03em] text-[#64748B] font-semibold block mb-1">
                Meals
              </span>
              <span 
            ...
            <div className="text-center p-3.5 px-2 border border-[#E2E8F0] rounded-[8px] bg-[#F8FAFC] col-span-2 sm:col-span-1">
              <span className="text-[10.5px] uppercase tracking-[0.03em] text-[#64748B] font-semibold block mb-1">
                Symptoms
              </span>
              <span 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3.5 mb-0">
          ...
          <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-[10px] p-5 shadow-2xs flex flex-col justify-between">
            <div>
              <div className="text-[13px] font-semibold text-[#0F172A] mb-0.5">Content library</div>
              <div className="text-[12px] text-[#64748B] mb-4">Manage application recipes and exercises</div>

              <div className="grid grid-cols-2 gap-2.5 mb-4">
                <div className="flex items-center justify-between p-3.5 border border-[#E2E8F0] rounded-[8px] bg-[#F8FAFC]">
                  <div>
                  ...
                  <div className="w-[34px] h-[34px] rounded-[8px] bg-[#EAF5FC] text-[#2E9AE8] flex items-center justify-center shrink-0">
                    <Utensils size={16} />
                  </div>
                </div>
            ...
            <div className="flex gap-2.5">
              <button
                onClick={() => navigate("/foods")}
                className="flex-1 p-2.5 border border-[#E2E8F0] rounded-[8px] bg-[#FFFFFF] hover:border-[#2E9AE8] hover:text-[#1C7AC8] text-[12px] font-semibold text-[#0F172A] text-center cursor-pointer transition-colors shadow-2xs"
              >
                Food library
              </button>
              <button
          ...
          <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-[10px] p-5 shadow-2xs flex flex-col justify-between">
            <div>
              <div className="text-[13px] font-semibold text-[#0F172A] mb-0.5">Recent admin activity</div>
              <div className="text-[12px] text-[#64748B] mb-4">Real-time audit log of administrative events</div>
              ...
              {recent_activity && recent_activity.length > 0 ? (
                <div className="space-y-2 max-h-[200px] overflow-y-auto pr-1">
                  {recent_activity.map((act, i) => {
                    ...
                    return (
                      <div 
                        key={act.id || i} 
                        className="flex justify-between items-start p-2.5 px-3 border border-[#E2E8F0] rounded-[8px] bg-[#F8FAFC]"
                      >
                        <div className="flex-1 min-w-0 pr-2">
                          <div className="flex items-center gap-1.5 mb-1">
                            <span className="w-4 h-4 rounded-full bg-[#EAF5FC] text-[#2E9AE8] text-[8.5px] font-bold flex items-center justify-center">
                              {initial}
                            </span>
                        ...
                        <span className="text-[10px] text-[#94A3B8] font-semibold uppercase whitespace-nowrap pt-0.5">
                          {formattedTime}
                        </span>
                      </div>
                    );
                ...
                <div className="py-8 text-center text-[#94A3B8] text-[12px] border border-dashed border-[#E2E8F0] rounded-[8px] bg-[#F8FAFC]/50">
