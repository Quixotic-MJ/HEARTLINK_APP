        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs font-medium">
              ...
              <div>
                <p className="text-[9px] text-slate-400 uppercase">Reported Health Conditions</p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-4">
            ...
            <p className="text-[10px] text-slate-500">Review the recommended content generated by the ML pipeline for this user.</p>
            ...
            <div className="pt-2 border-t border-slate-100">
              ...
              <p className="text-[10px] text-slate-500 mb-2">Provide feedback regarding recommendation tier suitability for this user's baseline.</p>
              <textarea
                rows="2"
