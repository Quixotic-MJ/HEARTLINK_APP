        ...
        >
          ...
          <View className="bg-white rounded-2xl border border-slate-200/70 px-6 py-7">
            ...
            <View className="items-center mb-7">
              <View
                className="w-16 h-16 rounded-2xl items-center justify-center mb-5 border border-slate-200/70"
                style={{ backgroundColor: "#e6f1fb" }}
              >
                <Feather name="smartphone" size={26} color="#185fa5" />
              </View>
              <Text className="text-[24px] font-medium text-slate-900 tracking-tight mb-2 text-center">
                Verify your account
              </Text>
              ...
              <View className="flex-row items-center gap-1.5 mt-3 bg-slate-50 border border-slate-200/70 px-3 py-1.5 rounded-xl">
            ...
            <View className="flex-row justify-center items-center gap-1">
              ...
              {canResend ? (
                <TouchableOpacity activeOpacity={0.65} onPress={handleResend}>
                  <Text className="text-[13px] font-medium text-slate-700">Resend</Text>
                </TouchableOpacity>
              ) : (
