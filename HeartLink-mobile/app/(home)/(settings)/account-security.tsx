  ...
  return (
    <SafeAreaView className="flex-1 bg-slate-50 dark:bg-slate-950" edges={["top"]}>
      ...
      <View className="flex-row items-center px-5 pt-4 pb-3 border-b border-slate-200 dark:border-slate-800/50 bg-white dark:bg-slate-900 dark:bg-slate-100">
        ...
        <Text className="text-[17px] font-medium text-slate-900 dark:text-white dark:text-slate-900">Account security</Text>
      </View>
      ...
      <ScrollView contentContainerClassName="px-5 py-6 pb-16" showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-white dark:bg-slate-900 dark:bg-slate-100 rounded-2xl border border-slate-200 dark:border-slate-800/70 p-4 mb-6">
          <Text className="text-[15px] font-medium text-slate-900 dark:text-white dark:text-slate-900 mb-4">Change Password</Text>
          ...
          <TouchableOpacity className="bg-slate-900 dark:bg-slate-100 h-12 rounded-xl items-center justify-center mt-2">
            <Text className="text-white dark:text-slate-900 font-medium text-[15px]">Update Password</Text>
          </TouchableOpacity>
        </View>
